        ...
        try {
            ...
            <div style='background-color: #0D0D2B; padding: 20px; text-align: center; color: #E5E5E5; font-family: Arial, sans-serif;'>
                <div style='max-width: 600px; margin: auto; background-color: #1B1E56; padding: 20px; border-radius: 10px; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.5);'>
                    ...
                    <h1 style='background: linear-gradient(90deg, #F72585, #4361EE); -webkit-background-clip: text; -webkit-text-fill-color: transparent;'>Reset Your Password 🔑</h1>
                    <p style='font-size: 16px; line-height: 1.5;'>Click the button below to reset your password:</p>
                    <a href='$resetLink' style='display: inline-block; margin: 20px auto; padding: 15px 25px; font-size: 18px; color: #fff; background: linear-gradient(90deg, #F72585, #4361EE); text-decoration: none; border-radius: 5px; font-weight: bold;'>🔒 Reset Password</a>
...
<body>
    <main>
        <div class="logo">
            <img src="./../img/logo.png" alt="Gameverse Logo" class="logo-img">
        </div>

        <?php if (isset($_SESSION['message'])): ?>
            <div id="container-message">
                <div id="<?php echo $_SESSION['message_type'] == 'success' ? 'success-message' : 'error-message'?>">
